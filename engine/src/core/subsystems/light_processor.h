...
namespace Sunset
{
	...
	public:
		...
		std::array<glm::vec4, 8> get_world_space_frustum_corners(class CameraControlComponent* camera_comp, float near, float far, glm::vec3& out_center, float inflation_factor = 1.0f);
	};
}
