...
namespace Sunset
{
	...
	public:
		...
		void reset();
		void operator()(class GraphicsContext* const gfx_context, void* command_buffer, RenderPassID render_pass, MaterialID material, ResourceStateID resource_state, const PushConstantPipelineData& push_constants = {}, const std::vector<DescriptorLayoutID>& descriptor_layouts = {});
		void operator()(class GraphicsContext* const gfx_context, void* command_buffer, RenderPassID render_pass, const IndirectDrawBatch& indirect_draw, class Buffer* indirect_buffer, const PushConstantPipelineData& push_constants = {}, const std::vector<DescriptorLayoutID>& descriptor_layouts = {});
	...
	class MeshTaskQueue
	{
		public:
			...
			void submit_draws(class GraphicsContext* const gfx_context, void* command_buffer, RenderPassID render_pass, const std::vector<DescriptorLayoutID>& descriptor_layouts, bool b_flush = true);
		...
		private:
			...
			MeshRenderTaskExecutor executor;
