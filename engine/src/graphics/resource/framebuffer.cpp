...
namespace Sunset
{
	Sunset::FramebufferID FramebufferFactory::create(class GraphicsContext* const gfx_context, void* render_pass_handle /*= nullptr*/, const std::vector<RenderPassAttachmentInfo>& attachments /*= {}*/, bool b_auto_delete /*= false*/)
	{
		bool b_added{ false };
